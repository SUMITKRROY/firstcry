import 'dart:async';
import 'package:firstcry/bottomnavbar.dart';
import 'package:flutter/material.dart';

class FirstCry extends StatefulWidget {
  @override
  State<FirstCry> createState() => _FirstCryState();
}

class _FirstCryState extends State<FirstCry> {
        ...
        ListView(
          ...
          children: [
            Column(
              children: [
                Container(
                  height: height * 0.2, // Adjust the height as per your requirements
                  width: width,
